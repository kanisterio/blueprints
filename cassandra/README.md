...
* Kanister controller version 0.119.0 installed in your cluster, let's say in namespace `<kanister-operator-namespace>`
...
$ helm install cassandra bitnami/cassandra --namespace <app-namespace> --set image.repository=kanisterio/cassandra --set image.tag=0.119.0 --set cluster.replicaCount=2 --set image.registry=ghcr.io --set image.pullPolicy=Always
