...
- Kanister controller version 0.119.0 installed in your cluster
...
$ helm install kanister --namespace kanister --create-namespace kanister/kanister-operator --set image.tag=0.119.0
```
